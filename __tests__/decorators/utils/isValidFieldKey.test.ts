...
describe('`isValidFieldKey`', () => {
  ...
  it('should throw errors that correctly reference the decorator name and key', () => {
    ...
    expect(() => isValidFieldKey(decoratorName, key)).toThrow(
  ...
  it('should throw an error if the key is not a string', () => {
    ...
    expect(() => isValidFieldKey('some-decorator', key)).toThrow(
      `@some-decorator can only be applied to specific keys. Expected key ${key.toString()} to be of type string, but received ${typeof key}.`,
    );
  });
  ...
  it('should throw an error if the key is an empty string', () => {
    ...
    expect(() => isValidFieldKey('some-decorator', key)).toThrow(
      '@some-decorator can only be applied to specific keys. Expected key to be non-empty.',
    );
  });
  ...
  it('should throw an error if the key contains reserved characters', () => {
    ...
    expect(() => isValidFieldKey('some-decorator', key)).toThrow(
      `@some-decorator can only be applied to specific keys. Expected key ${key} to not contain any reserved characters, but found ${key}.`,
    );
  });
  ...
  it('should throw an error if the key contains first only characters after the first character', () => {
    ...
    expect(() => isValidFieldKey('some-decorator', key)).toThrow(
      `@some-decorator can only be applied to specific keys. Expected key ${key} to not contain the characters ${firstOnlyCharacter}, except as the first character.`,
    );
  });
  ...
  it('should throw an error if the key contains middle only characters as the first or last character', () => {
    ...
    expect(() => isValidFieldKey('some-decorator', key)).toThrow(
      `@some-decorator can only be applied to specific keys. Expected key ${key} to not contain the characters ${middleOnlyCharacter}, ${middleOnlyCharacter} as the first or last character.`,
    );
  });
